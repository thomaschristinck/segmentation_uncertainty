...
DEFAULT_DATA_DIR = '/cim/data/neurorx/MS-LAQ-302-STX/imaging_data' #usr/local/data/thomasc/paul/MSLAQ'   #'/cim/data/neurorx/MS-LAQ-302-STX/imaging_data'
...
class Converter:
    ...
    def run(self):
        ...
        for idx,(site,subj) in enumerate(subjs):
        ...
        np.save('/cim/data/mslaq_raw/tf_mslaq/mslaq.npy', subj_array)
...
if __name__=="__main__":
    c = Converter('/cim/data/mslaq_raw/tf_mslaq/mslaq.tfrecord')  #'/usr/local/data/thomasc/paul/test/mslaq/mslaq.tfrecord')     #/cim/tnair/mslaq5.tfrecord)
    c.run()
    print('Done')
